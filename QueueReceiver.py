...
from pydantic import BaseModel, PositiveInt, Annotated,annotated_types


class QueueReceiver(BaseModel):
    gw_port: PositiveInt
    bl_port: Annotated[int, annotated_types.Gt(0)]
    gw_addr: Annotated[bytes, annotated_types.Length(min_length=0, max_length=15)]
    bl_addr: Annotated[bytes, annotated_types.Length(min_length=0, max_length=15)]
